...
const Button: FunctionComponent<{[name: string]: any, buttonStyle?: 'base' | 'primary' | 'danger', disabled?: boolean}> = (props) => {
    const style = {
        ...
        disabled: 'bg-gray-100 hover:bg-gray-200 rounded-md transition p-2 m-1'
    };
    const styleChosen = (props.disabled ? 'disabled' : props.buttonStyle || 'base');
